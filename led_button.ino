...
#define NUM_LEDS 60
#define DATA_PIN 7 //LED PIN FOR NEOPIXEL
...
#define PIN 7 //LED PIN FOR FASTLED
...
//3 color cylon, 3 repeated segments for each color, can be greatly improved.
...
void loop() 
{
  ...
  switch (c)
  {
    ...
    case 11:
     SnowSparkle(50,50,50, 200, random(100,1000)); // set first 3, set base color of "snow" 
    break;
